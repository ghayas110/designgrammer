    ...
    <header className="bg-white shadow-md  w-full z-10">
      <div className="container mx-auto flex items-center justify-between px-6 py-3">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <div href="#" className="text-sm font-medium text-gray-700 hover:underline cursor-pointer" onClick={() => router.push("/instructor")}>
            My Instructor
          </div>
          <div href="#" className="text-sm font-medium text-gray-700 hover:underline cursor-pointer" onClick={() => router.push("/admin")}>
            Admin
          </div>
