...
export default function DashboardLayout({ children }) {
    ...
    const isCourseDetail = pathname.startsWith("/dashboard/") && pathname !== "/dashboard";
    ...
    const menuItems = isCourseDetail
        ? [
              { name: "Lectures", href: pathname },
              { name: "Assignments", href: `${pathname}/assignments`, icon: "📝" },
              { name: "Quizzes", href: `${pathname}/quizzes`, icon: "❓" },
              { name: "Announcements", href: `${pathname}/announcements`, icon: "📢" },
          ]
        : [
